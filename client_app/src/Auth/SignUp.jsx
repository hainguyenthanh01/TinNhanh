                                ...
                                <div className="login-form">
                                    ...
                                    <div className="row">
                                        <div className="col-md-12 mb-20">
                                            ...
                                            {
                                                errorEmail && <span style={{ color: 'red' }}>* Email là bắt buộc!</span>
                                            }  
                                        </div>
                                        <div className="col-md-12 mb-20">
                                            ...
                                            {
                                                errorFullname && <span style={{ color: 'red' }}>* Tên đầy đủ là bắt buộc!</span>
                                            }  
                                        </div>
                                        <div className="col-md-12 mb-20">
                                        ...
                                        <div className="col-md-6 mb-20">
                                            ...
                                            {
                                                errorConfirm && <span style={{ color: 'red' }}>* Mật khẩu là bắt buộc!</span>
                                            }
                                            {
